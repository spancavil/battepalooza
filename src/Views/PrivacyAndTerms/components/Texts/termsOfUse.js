...
ANY PURCHASE OR SALE YOU MAKE, ACCEPT OR FACILITATE OUTSIDE OF THIS APP (AS DEFINED BELOW) OF an NFT (AS DEFINED BELOW) WILL BE ENTIRELY AT YOUR RISK. WE DO NOT CONTROL OR ENDORSE PURCHASES OR SALES OF NFTS OUTSIDE OF THIS APP. WE EXPRESSLY DENY ANY OBLIGATION TO INDEMNIFY YOU OR HOLD YOU HARMLESS FOR ANY LOSSES YOU MAY INCUR BY TRANSACTING, OR FACILITATING TRANSACTIONS, IN NFTS OUTSIDE OF THIS APP.

This document contains very important information regarding your rights and obligations, as well as conditions, limitations and exclusions that might apply to you. Please read it carefully.

These terms require the use of arbitration to resolve disputes, rather than recourse to the judicial system.  nWay, Inc.. ("we", "us" or “our”) is making the Battlepalooza application (the “App”) available to you. The App provides users with the opportunity to purchase, collect and showcase digital blockchain collectibles containing exclusive content. Before you use the App, you will need to agree to these Terms and Conditions of Use and any terms and conditions incorporated herein by reference (collectively, these “Terms”).

BY USING THE APP OR ANY PART OF IT, YOU ARE CONFIRMING THAT YOU UNDERSTAND AND AGREE TO BE BOUND BY ALL OF THESE TERMS.
...
1.10. Forte Platform. The Company and the Service relies upon the Forte-provided platform to enable all blockchain and Digital Asset functionality. You agree that, if the Company’s relationship with or access to the Forte platform terminates for any reason, neither Forte nor PTI have any responsibility for any losses or liabilities that may occur, directly or indirectly, as a result of such termination (including impacts on the valuation or liquidity of your Digital Assets). 
...
1.12. Taxes. It is your sole responsibility to determine whether, and to what extent, any taxes apply to the Digital Assets and any transactions you conduct through the Service, and to withhold, collect, report and remit the correct amounts of taxes to the appropriate tax authorities. 
...
(iii) Account Security. You are responsible for the security of your account for the App and for your electronic wallets. If you become aware of any unauthorized use of your password or of your account with us, you agree to notify us immediately at support@nwayplay.com

(iv) Account Transactions.  You can use your electronic wallet to purchase, store, and engage in transactions using your credit card or USD Coin, a digital stablecoin that is pegged to the United States dollar. Transactions that take place on the App are managed and confirmed via the Forte Platform. You understand that your Forte Platform public address will be made publicly visible whenever you engage in a transaction on the App.

3. PURCHASING AND EARNING YOUR NFTS  

(i) Acquiring NFTs. The App allows you to purchase, earn, collect and showcase NFTs (each, a “NFT”).  Each NFT is on the Forte Platform. 

(ii) Purchasing NFTs. You can purchase NFTs in two ways: (a) by buying packs of NFTs from us on the App (each, a “Box”); or (b) by buying NFTs from other users in the App’s marketplace (the “Marketplace”). There are different types of Packs available for purchase on the App, and we reserve the right to modify the types, prices and numbers of Packs available at our discretion. Depending on the type of Box you buy, you will collect NFTs of varying levels of scarcity.  Before you buy a Box, we will let you know the types of NFTs (but not the exact NFTs) that are contained in that Box.  If you buy an individual NFT from another user in the Marketplace, you will know the exact NFT that you are purchasing. We strongly encourage you not to purchase NFTs other than in Packs or on the Marketplace.  If you decide to purchase NFTs in any other way, you understand that such purchases will be entirely at your sole risk. 

(iii) Earning NFTs. From time to time, we may offer opportunities for you to earn NFTs by participating in certain challenges or marketing campaigns on the App, or by completing certain in-App tasks.

(iv) Characteristics of NFTs. NFTs are comprised of exclusive content, and the types of content will vary. For example, and without limitation, the content may be comprised of a digital image, a video, and set of data and information associated with the digital collectible.  Each NFT has a defined set of attributes – including scarcity – which help determine the value of the NFT. 

(v) Subjectivity of NFTs. The value of each NFT is inherently subjective, in the same way the value of other collectibles is inherently subjective. Each NFT has no inherent or intrinsic value. Some collectors might prefer to have an NFT featuring certain characteristics, while another might prefer an equivalent NFT featuring different characteristics.  Each collection can have more than one NFT associated with them, and those NFTs will each have different characteristics.

4.  PAYMENT, GAS FEES, TAXES, RELEASE OF PURCHASED NFTS, AND KYC REQUIREMENTS

(i) Financial Transactions on App. Any payments or financial transactions that you engage in via the App will be conducted solely through the Forte Platform.  We have no control over these payments or transactions, nor do we have the ability to reverse any payments or transactions. We have no liability to you or to any third party for any claims or damages that may arise as a result of any payments or transactions that you engage in via the App, or any other payment or transactions that you conduct via the Forte Platform. We do not provide refunds for any purchases that you might make on or through the App – whether for NFTs, Packs, or anything else.

(ii) Gas Fees. Every transaction on the Forte Platform requires the payment of a transaction fee (each, a “Gas Fee”). The Gas Fees fund the network of computers that run the decentralized Forte Platform. This means that you will need to pay a Gas Fee for each transaction that you instigate via the App. Except as otherwise expressly set forth in these Terms, you will be solely responsible to pay any Gas Fee for any transaction that you instigate via the App.
...
(iii) Release of NFT after Purchase. After you purchase an NFT on the App, it may take up to 3 days for the NFT to be released to you. Before the NFT is released to you, you will not be able to trade or take any actions with respect to the NFT.       

(iv) KYC Requirements. You will be required to satisfactorily complete an identity verification process in connection with know-your-customer (KYC) legal requirements prior to effecting certain actions or transactions.  These include, but are not necessarily limited to:
• 	withdrawing fiat currency from your account to a U.S. bank;
• 	transactions greater than a certain amount (currently set to $3,000, but subject to change at our sole discretion);
• 	depositing over $10,000 in value over the life of your account; and
• 	accumulating a balance of over $2,000 in value during the course of a single day.

KYC re-screening may also be required after certain events, such as changing your personal information (e.g., name, address, etc.).  Further, and in addition to any KYC requirements, we may delay withdrawals for up to 2 weeks at our sole discretion for purposes of deterring fraudulent users or activities and/or for other reasons. 

5.  OWNERSHIP, LICENSE, AND OWNERSHIP RESTRICTIONS

YOUR OWNERSHIP OF NFTS WILL ONLY BE RECOGNIZED BY US IF YOU HAVE PURCHASED OR OTHERWISE RIGHTFULLY ACQUIRED SUCH NFTS FROM A LEGITIMATE SOURCE AND NOT THROUGH ANY OF THE CATEGORY B PROHIBITED ACTIVITIES (AS DEFINED BELOW IN SECTION 5).

For the purposes of this Section 5, the following capitalized terms will have the following meanings: 

“Art” means any art, design, and drawings (in any form or media, including, without limitation, video or digital images) that may be associated with an NFT that you Own.

“Own” means, with respect to an NFT, an NFT that you have purchased or otherwise rightfully acquired from a legitimate source (and not through any of the Category B Prohibited Activities (as defined below)), where proof of such purchase is recorded on the Forte Platform.

“Purchased NFT” means an NFT that you Own. 

“Third Party IP” means any third party patent rights (including, without limitation, patent applications and disclosures), copyrights, trade secrets, trademarks, know-how or any other intellectual property rights recognized in any country or jurisdiction in the world.

(i) Ownership of NFT.  Because each NFT is on the Forte Platform, when you purchase an NFT in accordance with these Terms (and not through any of the Category B Prohibited Activities (as defined below in Section 5)), you own the underlying NFT completely. Ownership of the NFT is mediated entirely by the Forte Platform. Except as otherwise permitted by these Terms in cases where we determine that the NFT has not been rightfully acquired from a legitimate source (including, without limitation, through any of the Category B Prohibited Activities), at no point will we seize, freeze, or otherwise modify the ownership of any NFT.
...
(i) User Warranties.  Without limiting the foregoing, you warrant and agree that your use of the App will not (and will not allow any third party to):
...
(4)  involve using, employing, or operating Bots or other similar forms of automation to engage in any activity or transaction on the App (including, without limitation, purchases of Packs, or of NFTs on the Marketplace);
...
(i) You Terminate. You may terminate these Terms at any time by canceling your account on the App and discontinuing your access to and use of the App. If you cancel your account, or otherwise terminate these Terms, you will not receive any refunds for any purchases that you might make on or through the App – whether for NFTs, Packs, or anything else.
...
WE WILL NOT BE RESPONSIBLE OR LIABLE TO YOU FOR ANY LOSSES YOU INCUR AS THE RESULT OF YOUR USE OF THE FORTE PLATFORM, OR YOUR ELECTRONIC WALLET, INCLUDING BUT NOT LIMITED TO ANY LOSSES, DAMAGES OR CLAIMS ARISING FROM: (I) USER ERROR, SUCH AS FORGOTTEN PASSWORDS OR INCORRECTLY CONSTRUED SMART CONTRACTS OR OTHER TRANSACTIONS; (II) SERVER FAILURE OR DATA LOSS; (III) CORRUPTED WALLET FILES; OR (IV) UNAUTHORIZED ACCESS OR ACTIVITIES BY THIRD PARTIES, INCLUDING, BUT NOT LIMITED TO, THE USE OF VIRUSES, PHISHING, BRUTE-FORCING OR OTHER MEANS OF ATTACK AGAINST THE APP, THE FORTE PLATFORM, OR ANY ELECTRONIC WALLET.

NFTS ARE INTANGIBLE DIGITAL ASSETS THAT EXIST ONLY BY VIRTUE OF THE OWNERSHIP RECORD MAINTAINED IN THE FORTE PLATFORM. ALL SMART CONTRACTS ARE CONDUCTED AND OCCUR ON THE DECENTRALIZED LEDGER WITHIN THE FORTE PLATFORM. WE HAVE NO CONTROL OVER AND MAKE NO GUARANTEES OR PROMISES WITH RESPECT TO SMART CONTRACTS.

WE ARE NOT RESPONSIBLE FOR LOSSES DUE TO BLOCKCHAINS OR ANY OTHER FEATURES OF THE FORTE PLATFORM, OR ANY ELECTRONIC WALLET, INCLUDING BUT NOT LIMITED TO LATE REPORT BY DEVELOPERS OR REPRESENTATIVES (OR NO REPORT AT ALL) OF ANY ISSUES WITH THE BLOCKCHAIN SUPPORTING THE FORTE PLATFORM, INCLUDING FORKS, TECHNICAL NODE ISSUES, OR ANY OTHER ISSUES HAVING FUND LOSSES AS A RESULT.
...
NWAY’S AGGREGATE CUMULATIVE LIABILITY TO YOU ARISING FROM OR RELATING TO THESE TERMS, THE APP, AND THE NFTs, FOR ANY CAUSE WHATSOEVER, REGARDLESS OF THE FORM OF THE ACTION, AND EVEN IF A REMEDY SET FORTH HEREIN IS FOUND TO HAVE FAILED OF ITS ESSENTIAL PURPOSE, WILL AT ALL TIMES BE LIMITED TO THE LESSER OF (A) FIFTY US DOLLARS ($50) OR (B) THE AMOUNTS YOU HAVE PAID NWAY IN THE TWO (2) MONTHS PRECEDING THE DATE OF THE FIRST CLAIM GIVING RISE TO THE LIABILITY.
...
(i) Value and Volatility. The prices of collectible blockchain assets are extremely volatile and subjective and collectible blockchain assets have no inherent or intrinsic value. Fluctuations in the price of other digital assets could materially and adversely affect the value of your NFTs, which may also be subject to significant price volatility. Each NFT has no inherent or intrinsic value. We cannot guarantee that any NFTs purchased will retain their original value, as the value of collectibles is inherently subjective and factors occurring outside of the Battlepalooza ecosystem may materially impact the value and desirability of any particular NFT.

(ii) Tax Calculations. You are solely responsible for determining what, if any, taxes apply to your NFT-related transactions. We are not responsible for determining the taxes that apply to your transactions on the App.

(iii) Use of Blockchain. The App does not store, send, or receive NFTs. This is because NFTs exist only by virtue of the ownership record maintained on the App’s supporting blockchain in the Forte Platform. Any transfer of NFTs occurs within the supporting blockchain in the Forte Platform, and not on the App.

(iv) Inherent Risks with Internet Currency. There are risks associated with using an Internet-based currency, including, but not limited to, the risk of hardware, software and Internet connections, the risk of malicious software introduction, and the risk that third parties may obtain unauthorized access to information stored within your electronic wallet. You accept and acknowledge that we will not be responsible for any communication failures, disruptions, errors, distortions or delays you may experience when using the Forte Platform, however caused.

(v) Regulatory Uncertainty. The regulatory regime governing blockchain technologies, cryptocurrencies and tokens is uncertain, and new regulations or policies may materially adversely affect the development of the Battlepalooza ecosystem, and therefore the potential utility or value of your NFTs.

(vi) Software Risks. Upgrades to the Forte Platform, a hard fork in the Forte Platform, or a change in how transactions are confirmed on the Forte Platform may have unintended, adverse effects on all blockchains using the Forte Platform’s NFT standard, including the Battlepalooza ecosystem.  
...
(i) Binding Arbitration. All disputes arising out of or in connection with this contract, or in respect of any defined legal relationship associated therewith or derived therefrom, shall be referred to and finally resolved by binding arbitration in San Francisco County, State of California, USA.  Arbitration will be under the auspices of, and pursuant to the rules of, the American Arbitration Association’s Commercial Arbitration Rules as then in effect.  
...
(i) Entire Agreement.  These Terms, together with our Privacy Policy and Cookie Policy (which are incorporated herein by reference), constitute the entire legal agreement between you and us and will be deemed to be the final and integrated agreement between you and us, and govern your access to and use of the App, and completely replace any prior or contemporaneous agreements between you and us related to your access to or use of the App, whether oral or written.
...
(vi) Governing Law. All matters arising out of or relating to these Terms will be governed by and construed in accordance with the laws of the State of California, USA.

(vii) Venue. Subject to Section 16 of these Terms, any legal action or proceeding arising under these Terms will be brought exclusively in the courts in San Francisco County in the State of California, and we and you irrevocably consent and attorn to the personal jurisdiction and venue there.
