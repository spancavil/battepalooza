...
const ModalRegister1 = ({setmodalRegister1, handleInputChange, Register, inputPrice, handleExpiryChange}) => {
    return (
            ...
            >
                <div className={styles.modalContent}>
                    ...
                    <div className={styles.inputsGroup}>
                        ...
                        <div className={styles.inputContainerExpiry}>
                            <Input
                                label="Expiry time"
                                handleChange={(hour) => handleExpiryChange(hour)}
                                widthContainer={"80%"}
                                width={"100%"}
                            />
                            <p>Hours</p>
