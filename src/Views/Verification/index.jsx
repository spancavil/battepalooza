  ...
  return (
    <>
      ...
      {modalNotRegistered && (
        <div className={styles.container}>
          <Modal title="NOT REGISTERED" handleClose={handleClose}>
            <span className={styles.contentTextCenter}>
              The email you entered is not registered to any nWayPlay service.
              Will you register?
            </span>
            <div
              style={{
      ...
      {modalUserNotFound && !linked && (
        <div className={styles.container}>
          <Modal2
            title="nWayPlay Account"
            handleClose={handleClose}
            additionalStyles={{ width: mobile ? "100vw" : "70vw" }}
          >
            <span className={styles.contentText}>
              You are registered to one of nWayPlay's services. Press proceed to
              link your nWayPlay account.
            </span>
            <span className={styles.contentText}>
            ...
            >
              Please link your account with nWayPlay using the mobile app in
              order to bring your saved data or game progress. If you do not
              link your Battlepalooza account using the mobile app, you might
              lose your game progress. We will not be responsible for lost data,
              or merge accounts for users who have more than one account. Please
              follow the following steps using the mobile app in order to link
              your account:
              <br />
              <br />
